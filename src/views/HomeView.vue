    ...
    <v-app id="inspire" :style="{background: $vuetify.theme.themes.dark.background}">
      ...
      <v-container>
          ...
          <v-toolbar color="rgba(0,0,0,0)" flat class="mt-n5">
              ...
              <v-btn color="#49D9A0" text class="ml-5">last spring</v-btn>
          </v-toolbar>
                            ...
                            <v-row>
                              <v-col cols="12" sm="12">
                                <v-list-item three-line class="mt-10">
                                  <v-list-item-content>
                                    <div class="mb-4">
                                      <v-icon x-large :color="active ? 'white' : '#49D9A0'">fas fa-user </v-icon>
                                    </div>
          ...
          <v-row class="mt-4">
              ...
              <v-col cols="12" md="5" sm="12">
                  <v-toolbar color="rgba(0,0,0,0)" flat class="mt-n2">
                      <v-toolbar-title>Spring stories</v-toolbar-title>
                      <v-spacer></v-spacer>
                      <v-btn rounded small>
                        See All
                      </v-btn>
          ...
          <v-toolbar color="rbga(0,0,0,0)" flat class="mt-4">
              ...
              <v-row>
                  <v-col cols="12" sm="3">
                      <v-list subheader two-line>
                          <v-list-item>
                            <v-badge bordered botton color="#49D9A0" dot offset-x="28" offset-y="22">
                                <v-list-item-avatar>
                                    <v-avatar size="40">
